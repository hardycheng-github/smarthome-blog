...
- 零火版（必須要中性線）
- Z2M支援（v2.3.0含以上）
- 官方售價`NT$792`～`NT$927`（2025/6/26天貓價格）
...
[天貓賣場](https://detail.tmall.com/item.htm?id=886920065912)不同鍵數售價換算台幣約NT$792～NT$927
...
目前已經完成所有鍵數的外部轉換器開發，請至[自訂外部轉換器](#自訂外部轉換器)查看
...
為了解決未來可能會遇到打不開外飾面板的窘境

強烈建議入手的各位照著以下步驟進行後加工

https://github.com/user-attachments/assets/c79ad5b1-a505-4312-80e9-e225049bb144
